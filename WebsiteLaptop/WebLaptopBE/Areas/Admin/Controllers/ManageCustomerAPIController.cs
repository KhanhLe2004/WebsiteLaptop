...
namespace WebLaptopBE.Areas.Admin.Controllers
{
    ...
    public class ManageCustomerAPIController : ControllerBase
    {
        ...
        public ManageCustomerAPIController(Testlaptop37Context context, IWebHostEnvironment environment, IHttpClientFactory httpClientFactory, HistoryService historyService)
        {
            _context = context;
